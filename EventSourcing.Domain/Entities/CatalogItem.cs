...
using EventSourcing.Domain.Events.CatalogItem;
    ...
    public class CatalogItem : BaseAggregateRoot<CatalogItem, Guid>
    {
        ...
        protected override void Apply(IDomainEvent<Guid> @event)
        {
            switch (@event)
            {
                ...
                case CatalogItemDeleted catalogItemDeleted: OnCatalogItemDeleted(catalogItemDeleted); break;
            }
        }
        ...
        // On Catalog Item Updated Event
        private void OnCatalogItemDeleted(CatalogItemDeleted catalogItemDeleted)
        {
